...
public class LecturaDAO implements IDAO<Lectura>, ILecturaDAO {
    ...
    /**
     * Método que devuelve una lista con todas las lecturas de la base de datos.
    ...
    /**
     * Método que devuelve una lectura buscándola por su id.
    ...
    /**
     * Método que inserta una nueva lectura en la base de datos.
    ...
    /**
     * Método que actualiza la página actual de una lectura existente en la base de datos.
    ...
    /**
     * Método que elimina una lectura de la base de datos.
    ...
    /**
     * Método que busca todas las lecturas de un perfil concreto.
    ...
    /**
     * Método que busca todas las lecturas de un cómic concreto.
